  ...
  if (!clientConnected) {
    ...
    if (client.connected()) {
      if (client.available()) {
        ...
        String queryTDS = String("GET ") + serverPath + "?TDS=" + TDS + " HTTP/1.1\r\n" + "Host: " + server + "\r\n" + "Connection: keep-alive\r\n\r\n";
        client.print(queryTDS);
        Serial.println(queryTDS);
        delay(500);

        String queryWL = String("GET ") + serverPath + "?WL=" + valueWaterHigh + " HTTP/1.1\r\n" + "Host: " + server + "\r\n" + "Connection: keep-alive\r\n\r\n";
        client.print(queryWL);
        Serial.println(queryWL);
        delay(500);
